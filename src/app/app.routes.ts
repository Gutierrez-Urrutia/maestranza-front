...
import { AlertasGuard } from './guards/alertas.guard';
...
export const routes: Routes = [
    ...
    { path: 'alertas', loadComponent: () => import('./pages/alertas/alertas.component').then(m => m.AlertasComponent), canActivate: [AuthGuard, AlertasGuard] },
